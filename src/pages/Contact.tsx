          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 truncate">vishwaangl@gmail.com</p>
              </div>
            </motion.a>
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 truncate">@vishwxa_</p>
              </div>
            </motion.a>
